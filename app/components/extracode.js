...
const Page = () => {
    ...
    }, [id, session, router,editInvoice,selectedInvoice]);
    ...
    const handleUpdateInvoice = async (e) => {
        ...
        try {
            ...
            // Ensure `invoices` state updates immediately
            const updatedInvoices = invoices.map(inv => 
                inv._id === selectedInvoice._id ? { ...selectedInvoice } : inv
            );
    ...
    const updateTotalAndGrandTotal = (updatedItems) => {
        ...
        setSelectedInvoice((prev) => ({
            ...
            grandTotal,
            balance_due_amount // Ensuring balance updates correctly
        }));
    };
    ...
    const handleAmountChange = (e) => {
        ...
        setSelectedInvoice((prev) => ({
            ...prev,
            received_amount,
            balance_due_amount: prev.grandTotal - received_amount, // Fix balance calculation
        }));
    };
       ...
       {invoices.length >0 ? <div className="w-full sm:w-auto text-center sm:text-left">
        ...
        >
            + Add Invoice
                ...
                {/* Add Invoice Modal */}
                {isAddClientOpen && (
                    <div className="w-full  absolute inset-0 flex items-center justify-center bg-opacity-50 z-50">
                ...
                {/* Invoice List */}
                <div className="container w-full h-[72vh] mx-auto px-4 sm:px-6 lg:px-8 mt-4">
                ...
                {invoices.length > 0 && (
                <div className="flex justify-center stickym-auto p-4 rounded-lg ">
                    <div className="flex">
